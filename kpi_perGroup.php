...
<div class="col-md-8">
        ...
        border-radius: 20px 20px 20px 20px;">
            ...
            <div class="media-body">
              <h2 class="text-dark display-12" style="font-family:Century Gothic;" >Group per Day 
      <a href="new_kpi.php">
...
<h2 style="color:; ">Table Filter</h2>
    ...
    <div class="tableFixHead">
       <table class="table order-table"  cellspacing="0" id="perGroup_daily">
          <thead >
            <tr>
...
SELECT  [Year]
 ...
 where [Date] BETWEEN '$mydate' AND '$mydate2' and  (ticket_group like 'private KAM%' or ticket_group like 'GDS%') and [Year] >='$this_year'
 ...
 (ticket_group like 'private KAM%' or ticket_group like 'GDS%') and [Year] >='$this_year'
---(ticket_group like 'private KAM%' or ticket_group like 'GDS%')
 union 
...
union
 ...
 select * from (
 select 
 [year],[month],[week],[date],[Ticket_group],Requestid,[Target],
 --,[Sub_group],[Last_enginner],[Requestid],
 [SLA],
 [KPI_Name]
...
select 
 [Year],[month],[Week],[Date],[Ticket_group],[KPI_Name],[Not Exceed], [Exceed],[Target],round(iif([Not Exceed] = 0 and [Exceed] = 0,0,cast([Not Exceed] as float) / (cast([Not Exceed] as float)+cast([Exceed] as float))),2) [percentage]
from final
...
SELECT  [Year]
      ...
      ,'98% for total_time_within_SD_pool_not_exceed_90_min' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_total_time_within_SD_pool_not_exceed_90_min]
 where [Date] BETWEEN '$mydate' AND '$mydate2'  and  Ticket_group like '$my_group%' and [Year] >='$this_year'
 ...
 SELECT  [Year]
      ...
      ,'98%_global_tickets_have_parent_ticket' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_93%_of_global_tickets_to_have_PSD_tickets]
 where  [Date] BETWEEN '$mydate' AND '$mydate2'  and [Year] >='$this_year' and
 ...
 union 
  ...
  SELECT  [Year]
      ...
      ,'90% of all tickets that not escalated to onsite or global to be resolved within 24 hours' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_MTTR_SD_24hr]
 where [Date] BETWEEN '$mydate' AND '$mydate2'  and [Year] >='$this_year' and  Ticket_group like '$my_group%'
...
echo $rows;
  ...
  ?>
    <script type="text/javascript">
        function Export() {
            $("#perGroup_daily").table2excel({
                filename: "perGroup_daily.xls"
            });
        }
    </script>
</tbody>
...
SELECT  [Year]
      ...
      ,'98% for total_time_within_SD_pool_not_exceed_90_min' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_total_time_within_SD_pool_not_exceed_90_min]
 where [Week] = '$newWeeks' and (ticket_group like 'private KAM%' or ticket_group like 'GDS%') and [Year] >='$this_year'
 union 
 SELECT  [Year]
      ,[month]
      ,[Week]
...
union
 ...
 select * from (
 select 
 [year],[month],[week],[Ticket_group],Requestid,[Target],
 [SLA],
 [KPI_Name]
...
select 
 [Year],[month],[Week],[Ticket_group],[KPI_Name],[Not Exceed], [Exceed],[Target],round(iif([Not Exceed] = 0 and [Exceed] = 0,0,cast([Not Exceed] as float) / (cast([Not Exceed] as float)+cast([Exceed] as float))),2) [percentage]
from final 

order by [Week],[KPI_Name]");
...
SELECT  [Year]
      ...
      ,'98% for total_time_within_SD_pool_not_exceed_90_min' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_total_time_within_SD_pool_not_exceed_90_min]
 where [Week] = '$newWeeks' and [Year] >='$this_year' and Ticket_group like '$my_group%'
 union 
 SELECT  [Year]
      ,[month]
      ,[Week]
...
echo $rows;
 ...
 <script type="text/javascript">
        function Export() {
            $("#perGroup_week").table2excel({
                filename: "perGroup_week.xls"
            });
        }
    </script>
 </tbody>
...
SELECT  [Year]
      ...
      ,'98% for total_time_within_SD_pool_not_exceed_90_min' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_total_time_within_SD_pool_not_exceed_90_min]
where [month] = '$newMonth' and (ticket_group like 'private KAM%' or ticket_group like 'GDS%') and [Year] >='$this_year'
 union 
 SELECT  [Year]
      ,[month]
      ,[Week]
...
union
 ...
 select * from (
 select 
 [year],[month],[Ticket_group],Requestid,[Target],
 [SLA],
 [KPI_Name]
...
select 
[Year],[month],[Ticket_group],[KPI_Name],[Not Exceed], [Exceed],[Target],round(iif([Not Exceed] = 0 and [Exceed] = 0,0,cast([Not Exceed] as float) / (cast([Not Exceed] as float)+cast([Exceed] as float))),2) [percentage]
from final
...
SELECT  [Year]
      ...
      ,'98% for total_time_within_SD_pool_not_exceed_90_min' [KPI_Name]
  FROM [WorkForce_Reporting_DB].[dbo].[tbl_total_time_within_SD_pool_not_exceed_90_min]
where [month] = '$newMonth' and Ticket_group like '$my_group%' and [Year] >='$this_year'
 union 
 SELECT  [Year]
      ,[month]
      ,[Week]
...
echo $rows;
  ...
  <script type="text/javascript">
        function Export() {
            $("#perGroup_Monthly").table2excel({
                filename: "perGroup_Monthly.xls"
            });
        }
    </script>
</tbody>
