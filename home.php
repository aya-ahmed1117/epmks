...
$out_all = sqlsrv_fetch_array($check_all, SQLSRV_FETCH_ASSOC);
$all_username = !empty($out_all) ? $out_all['username'] : null;
...
$check_engineers = sqlsrv_query( $con ,"SELECT * FROM employee WHERE id  = 8359 ");
while ( $output_engineers = sqlsrv_fetch_array($check_engineers)){
  //$output_engineers = $check_engineers->fetch_array()){
   $engineers_id = $output_engineers['id'];
    $engineers_id .' echo $engineers_id';
...
echo '
    <li>
      <a class="nav-link scrollto" href="chating.php?engineer_id=' . $engineers_id . '">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" height="410" src="images/wfm4.jpg">
    </div>

    <div class="carousel-item ">
      <img class="d-block w-100" height="410"src="images/wfm3.png" alt="Four slide">
    </div>
  

    <div class="carousel-item ">
      <img class="d-block w-100" height="410" src="images/workforce-management-1.jpg" alt="Five slide">
    </div>
