...
    $to_email       = "aya.abdelfattah@te.eg";
...
    $headers = "From:Fromname <esupport.net>" . $eol;
...
<head>
  <title></title>
  <link rel="stylesheet/less" type="text/css" href="style_table.less" />
...
$first_query = sqlsrv_query( $con ,"SELECT top 4 * FROM in_and_out WHERE  [engineer_id] = '$engineer_id' or username ='$s_username'  order by 4 DESC ,5 desc ");
/*username ='$s_username' order by 4 DESC ,5 desc*/
