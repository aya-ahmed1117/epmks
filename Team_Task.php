...
employee.[id],
  ...
  join employee on employee.username = [create_task].username and  engineer_id ='$engineer_id' order by [create_task].username  ");

  $rows.="<td class='cell100 column1 hovers'style='background-color:#55608f;'>
  <a style='color:yellow;font-size:13px;' href='Team_tasks.php?engineer_id=".$engineers_id."'>Deductions</a></td>";
  $rows.="</tr>";
  echo $rows;
  ...
  $rows.="<td class='cell100 column1 hovers' style='background-color:#55608f;'><a style='color:yellow;font-size:13px;' href='Team_tasks.php?engineer_id=".$engineers_id."'>Tasks</a></td>";
 $rows.="</tr>";
  echo $rows;
}
}
...
if($_SESSION['role_id'] == 3){
  ...
  $rows.="<td class='cell100 column1 hovers'style='background-color:#55608f;'>
  <a style='color:yellow;font-size:13px;' href='Team_tasks.php?engineer_id=".$engineers_id."'>Tasks</a></td>";
...
//Khaled.AbdAlRahman
if($_SESSION['username'] == 'Khaled.AbdAlRahman'){
