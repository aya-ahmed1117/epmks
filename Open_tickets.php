...
<div class="col-md-8">
        ...
        border-radius: 20px 20px 20px 20px;">
            ...
            <div class="media-body">
              <h2 class="text-dark display-12" style="font-family:Century Gothic;" >Open Ticket
    ...
    <i class="fa fa-backward"></i> Back
       ...
       <samp><p style="background-color:#55608f;font-weight:bold;font-size:16px;color:white;padding:2%;">To Download this table please click Excel button<a role="button" href="open_yesterdayEXCEL.php?export" download="open_yesterday.xls" >
