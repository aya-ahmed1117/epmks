...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <div class="u-background-video u-expanded">
        ...
        <div  class="middles">
        <!--   <h3 >
           يشرفني أن أرفع لكم أسمى آيات التهاني والتبريكات بمناسبة حلول شهر رمضان المبارك أعاده الله علينا وعليكم وعلى الأمة الإسلامية بالخير واليمن والبركات، وأعاننا وإياكم على صيامه وقيامه إنه سميع مجيب، وكل عام وأنتم بخير.
...
$repramadanN = str_replace('”' , "`", $ramadanN);
  ...
  <span class="snowflake"><img src="images/ramadan/fanoos202.png" width="15"></span>
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content"style="background-image: url(images/ramadan/ramadanNo.jpeg); background-repeat:no-repeat;
          background-size:cover;  ">
...
رمضـــــــان كريــــــم
                   <img rel="icon" src="images/ramadan/lamp20.gif" style="width:10%;filter: brightness(0.9);"/> 
                    ...
                    <audio controls >
  <source src="images/ramadan/Humood-MarhabYa Hilal.mp3" type="audio/ogg">
  <source src="images/ramadan/Humood-MarhabYa Hilal.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
