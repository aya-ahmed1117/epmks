...
#snowflakeContainer {
  ...
  <span class="snowflake"><img src="images/ramadan/fanoos202.png" width="20"></span>
</div>
<div>
          ...
          <li class="dropdown">
            ...
            <i class="bi bi-chevron-right"></i></a>
              <ul>
                ...
                <i class="fa fa-sign-out" ></i><span class="badge pull-right" id="myDIV" style="font-size:28px;">*</span></a></li>
 ...
 -->
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" height="415" width="10" src="images/ramadan/ramadan-kareem22" alt="First slide">
    </div>
    <div class="carousel-item ">
      <img class="d-block w-100" height="415" src="images/ramadan/fnanes2020.jpg"width="10" >
    </div>

    <div class="carousel-item ">
      <img class="d-block w-100" height="415" src="images/ramadan/ramadan-kareem.webp"width="10" >
    </div>

     <div class="carousel-item ">
      <img class="d-block w-100" height="415" src="images/ramadan/tri---ramadangidribbble.gif"width="10" >
    </div>

      <div class="carousel-item ">
      <img class="d-block w-100" height="415" src="images/ramadan/image_processing202.gif"width="10" >
    </div>

    <div class="carousel-item ">
      <img class="d-block w-100" height="415" src="images/Main_photo.jpg">
    </div>
...
<h2 class="text-dark display-12" >
    ...
    if ($time < "12") {
     ...
     <img src='images/ramadan/ramadannnn-preview'>Good morning bdfbgdfrgdrfx: $s_username</h3>";
    }if ($time >= "12" && $time < "17") {
    ...
    if ($time >= "12" && $time < "17") {
              ...
              <img class='card-img-top'src='images/afternoon_mew.jpg' style='background-size: cover;background-repeat: no-repeat;height:200px;'>
                <div class='centereds'>
                <h4 class='card-title mb-3' style='font-weight: bold; font-size:30px;'><img src='images/ramadan/ramadannnn-preview.png' width='60'>Good afternoon dfdff: $s_username</h4>
                </div></div>";}
    if ($time >= "17" && $time < "19") {
             echo"<div class='containers'>
...
<br>
 Dears,<br>
        kindly be informed that the payroll of this month will be sent to the HR, so kindly let your engineers under your supervision create all their deduction complains and their leaves and tasks to be handled on WFM tool to avoid any deductions by maximum 15-03-2022
         (12:00 PM)..
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
//  <img src="images/modern-happy-mother"style="background-repeat:no-repeat;
//    background-size:cover; width:50%;hight:30%; "> 

// <br>
// <br>
// Dears,
//   Kindly let  your engineers under your supervision to create official mission on  27-1-2022 with note " Revolution Day”  with their right shift start & shift end to cover this day as a day OFF to avoid any attendance problem .
