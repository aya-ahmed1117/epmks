  ...
  echo'<li ><a id="myDIV" href="Admin_approve.php" >
      ...
      <i class="bi bi-chevron-down"></i></a>
          <ul>    
            ...
            <li><a href="add_users_training.php" id="myDIV">Add users
              <img src="images/customer-data.png" style="width:20px;"></a></li>
            </ul>
          </li>';
        }
  ...
  ?>
      ...
      <i class="bi bi-chevron-down"></i></a>
          <ul>    
            ...
            <li>
              <a href="Ticketingsys_history.php">View ticket 
...
<?php if($role_id == 0){
          ?>
        <li>
          <a href="Create_Leaves.php">Create leaves<i class="fa fa-sign-out" ></i></a></li>
      <?php }?>
        <?php if($role_id >= 1){
          ?>
...
<button class="btn btn-primary btn-md"type="button" id="notification" data-toggle="modal" data-target="#largeModal" aria-haspopup="true" aria-expanded="false"><span class="count"><?php echo  $Notifi_num;?></span><i class="fa fa-bell"></i></button>
          ...
          <li>
            <a href="?logout"><span style="font-size:10px;">
            <i class="fa fa-sign-out"></i>
          </span>log out</a></li>
        </ul>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <div class="u-background-video u-expanded">
        ...
        <img src="images/ramadan/eid_we.png"width="1350">
          <!-- <video id="video-bg-elem" preload="auto" autoplay muted loop 
          width="1350"> 
            <source src="images/ramadan/ramazan-33348.mp4">
        </video> -->
        </div>
        <div  class="middles">
          <h3 >
...
عيــــــــــــــــــد سـعيـــــــــــــــــد     </p> -->
        </div>
      </div>
<script>
  const video = document.querySelector('video');
  video.currentTime = 36; // replace n with your desired second
  video.play();
</script>
...
<div class="parent">
       <div class="div1">
          <?php //include('ramadan_2021.php');?> 
           <img class="card-img" src='images/feast.jpg' style='background-size: contain;background-repeat: no-repeat; width: 69%;'>
        </div> 
  <div class="div2"> 
...
<?php
    ...
    if ($time < "12:13" ) {
     echo"<div class='containers'>";
             echo'<video id="video-bg-elem" muted controls   style="background-size: cover;background-repeat: no-repeat;height:350px;" width="100%"> 
...
اقترب موعد الافطار
    ...
    if ($time >= "18:30" && $time < "19:38") {
                echo"<div class='containers'>";
             echo'<video id="video-bg-elem" muted controls   style="background-size: cover;background-repeat: no-repeat;height:350px;" width="100%"> 
            <source src="images/ramadan/videoplayback1.mp4">
        </video>
                
              </div>';
            }
  if ($time >= "19:38" && $time < "23:59") {
                 echo"<div class='containers'>
      ...
      <ul class="list-group list-group-flush">
          <li class="list-group-item">
              <a href="https://www.edx.org/"> 
                <i rel="icon" >
                  <img rel="icon" src="images/EdX_Logo.png" style="width:20px;"/></i>
                <span> EDX</span>
              </a>
          </li>
          <li class="list-group-item">
              <a href="https://www.coursera.org/courses?query=free"> <i rel="icon" ><img rel="icon" src="images/coursera.png" style="width:20px;"/></i>Coursera
              </a>
          </li>
          <li class="list-group-item">
              <a href="https://www.udemy.com"> <i class="icon"><img rel="icon" src="images/udemy.png" style="width:20px;"/></i> Udemy
              </a>
          </li>
          <li class="list-group-item">
              <a href="https://www.futurelearn.com/courses"> <i class="icon"><img rel="icon" src="images/future-learn5.png" 
                style="width:9%;"/></i>
              FutureLearn
              </a>
          ...
          <li class="list-group-item">
              <a href="https://www.udacity.com/"> <i class="icon"><img rel="icon" src="images/udacity-icon.png" style="width:20px;"/></i>
               Udacity</a>
          </li>
        </ul>
...
<br>
 Dears,<br>
        kindly be informed that the payroll of this month will be sent to the HR, so kindly let your engineers under your supervision create all their deduction complains and their leaves and tasks to be handled on WFM tool to avoid any deductions by maximum '.$enddate.'
         (12:00 PM)..
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
*/
  ...
  $con1 = sqlsrv_connect($DBhost, $connectionInfo);
    ...
    //  if($_SESSION['username']=='aya.abdelfattah'){
      if(($mother_day)||($Gender =='female')|| ($Gender =='Female')){
...
.close2 {
  ...
  <div class="modal fade" id="mediumModal2" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-titles" id="mediumModalLabel" dir="rtl">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
           <center>
                <img src="images/ramadan/mother"style="background-repeat:no-repeat;
 ...
 //if($currentDate ){
  // if($_SESSION['username'] == 'aya.abdelfattah'){
    $today = date('09-03-2024');
    $dates = date('d');
    //if($today <= $currentDate ){

   
      $ramadan_notes = sqlsrv_query( $con ,"Declare @EndDate date= getdate();
        SELECT  [ID]
              ,[Date]
              ,[ramdan_quote]
          FROM [tranning_Database].[dbo].[ramdan_quote]
          where [date] = @EndDate");
      $ramadan = sqlsrv_fetch_array($ramadan_notes); 
      $ramadanN =$ramadan["ramdan_quote"]; 
      $Date_r =$ramadan["Date"]; 
...
$repramadanN = str_replace('”' , "`", $ramadanN);
   ...
   <div id="snowflakeContainer">
  <span class="snowflake"><img src="images/confetti.png" width="15"></span>
    </div>
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content"
          style="background-image: url(images/blaleen.png); background-repeat:no-repeat;
          background-size:cover;  ">
              <div class="modal-header" style="background-color: rgba(0, 0, 0, 0.6);">
                  ...
                  font-weight:bold; " >
                   <i ><img rel="icon" src="images/balloon.png" style="width:10%;filter: brightness(0.9);"/> 
                   </i>
                    عيــــــــد سعيـــــــد
                   <img rel="icon" src="images/balloon.png" style="width:10%;filter: brightness(0.9);"/> 
                    </h5>
                    <audio controls >
                      <source src="images/ramadan/takberat-eid.mp3" type="audio/ogg">
                      <source src="images/ramadan/takberat-eid.mp3" type="audio/mpeg">
                      Your browser does not support the audio element.
                    </audio>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<br>
        ...
        Dears,<br>
          Happy Eid
  Kindly create official mission with note ( Eid Vacation ) from 9 till 14-April-2024 if you take it as holiday and don’t forget to mention the start and end time of the shift in order to approve the leaves and to avoid any deduction
        </h3>

  <!--h2 height:"250" >'.$repramadanN .'-->
<br>
<br>
