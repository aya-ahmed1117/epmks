...
<div class="animated fadeIn ">
	...
	<div class="col-sm-6 col-md-3">
	    <div class="card text-white bg-flat-color-9">
			...
			<i class="icon fas fa-sign-out-alt" style="font-size: 1.48em;padding: 0;float: right;color: white;">
              ...
              <br>	
		<h6 class="text-light mt-1 m-0">Daily Average MTTR for all SD tickets either was escalated...</h6>
			</a>
    ...
    <a href="Daily_Average.php?MTTR">
		       <div class="card-left pt-1 float-left">
              <br>	
		<h6 class="text-light mt-1 m-0">Daily Average MTTR for SD tickets not escalated...</h6>
	</a>
      </div><!-- /.card-left -->
	</div>
  </div>
