...
<div class="col-md-8">
       ...
       color:white;">This page shows all your team deduction added on your Team and thier status (Pending manager approval / Rejected)</p>
  </aside>
</div>
</center>
...
<th class="cell100 column1"><center>Deduction</center></th>
...
employee.[id],
  ...
  join employee on employee.username = [deduction].username  and engineer_id ='$engineer_id' order by [deduction].username  ");

  $rows.="<td class='cell100 column1 hovers'style='background-color:#55608f;'>
  <a style='color:yellow;font-size:13px;' href='Team_dedcutions.php?engineer_id=".$engineers_id."'>Deductions</a></td>";
  $rows.="</tr>";
  echo $rows;
	...
	employee.[id],
	  [deduction].[username]
	FROM [Aya_Web_APP].[dbo].[deduction]
	join employee on employee.username = [deduction].username   engineer_id ='$engineer_id' order by [deduction].username ");

  $rows.="<td class='cell100 column1 hovers' style='background-color:#55608f;'><a style='color:yellow;font-size:13px;' href='Team_dedcutions.php?engineer_id=".$engineers_id."'>Deductions</a></td>";
 $rows.="</tr>";
  echo $rows;
}
}
