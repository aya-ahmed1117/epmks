...
<div class="col-md-8">
       ...
       color:white;">This is the final calulation for the on call after approval from your manager</p>
  </aside>
</div>
</center>
...
<center>
  ...
  <div class="col-md-8">
    ...
    <thead >
      <th style="color:#fff; text-align:center;">Username</th>
      <th style="color:#fff; text-align:center;">Employee Type</th>
      <th style="color:#fff; margin:0; text-align:center;">Week Day</th>
      <th style="color:#fff; margin:0; text-align:center;">Week End</th>
      <th style="color:#fff; margin:0; text-align:center;">Month</th>
      <th style="color:#fff; margin:0; text-align:center;">Year</th>
...
,[year]),
 ...
 diff_table.id
  ...
  ,diff_table.[year]
 from diff_table
 where username1 = '$s_username' order by [year] DESC , [month]  DESC");
