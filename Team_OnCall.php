...
<div class="col-md-8">
        ...
        border-radius: 20px 20px 20px 20px;">
            ...
            <div class="media-body">
              <h2 class="text-dark display-12" >My Team ONCall</h2>
...
<th class="cell100 column1"><center>Oncall</center></th>
...
employee.[id],
  ...
  join employee on employee.username = [create_task].username   engineer_id ='$engineer_id' order by [create_task].username  ");

  $rows.="<td class='cell100 column1 hovers'style='background-color:#55608f;'>
  <a style='color:yellow;font-size:13px;' href='Team_OnCalls.php?engineer_id=".$engineers_id."'>Deductions</a></td>";
  $rows.="</tr>";
  echo $rows;
  ...
  $rows.="<td class='cell100 column1 hovers' style='background-color:#55608f;'><a style='color:yellow;font-size:13px;' href='Team_OnCalls.php?engineer_id=".$engineers_id."'>Oncall</a></td>";
 $rows.="</tr>";
  echo $rows;
}
}
...
if($_SESSION['role_id'] == 3){
  ...
  $rows.="<td class='cell100 column1 hovers'style='background-color:#55608f;'>
  <a style='color:yellow;font-size:13px;' href='Team_OnCalls.php?engineer_id=".$engineers_id."'>Oncall</a></td>";
