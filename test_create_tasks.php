...
<div class="input-group md-2">
  ...
  <input type="time" class="form-control stime" placeholder="Enter Start Time" name="stime" 
  id="starttime"
...
<div  class="input-group" >
  <span class="input-group-text" id="basic-addon1">Choose</span>
  <select class="form-control evidence" name="evidence">
