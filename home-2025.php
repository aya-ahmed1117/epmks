...
<!--   <div id="snowflakeContainer">
     <span class="snowflake"><img src="images/Iconarchive-Cute.png" width="20"></span>
  </div> -->
<div>
...
SELECT count(distinct deduction.[id]) as test   FROM deduction
  ...
  WHERE  [status] in 
  ('SENIOR APPROVE','senior approve','super approve','section approve','Unit Approve') 
...
<?php if($role_id == 0){
          ?>
        <li><a href="Create_Leaves.php">Create leaves<i class="fa fa-sign-out" ></i></a>
        </li>
      <?php }?>
        <?php if($role_id >= 1){
          ?>
   ...
   $check_all = sqlsrv_query( $con ,"SELECT 
            ...
            where unit in (11,12, 13 ,14, 15 ,16 ,17,18) and b.username = '$s_username'  ");
 ...
 -->
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" height="410" src="images/Main_photo.jpg">
    </div>

    <div class="carousel-item ">
      <img class="d-block w-100" height="410"src="images/Homepage-Banner-1700Wx651H-En.jpg" alt="Four slide">
    </div>
  

    <div class="carousel-item ">
      <img class="d-block w-100" height="410" src="images/WE-Access-Business-TE-ENG.jpg" alt="Five slide">
    </div>
...
<h2 class="text-dark display-12" >
    ...
    $time = date("H");
    if ($time < "12") {
     "<h3 style='font-size:20px;'><img src='images/morning.png' style='width:50px;'>
     <img src='images/4438162.png'>Good morning bdfbgdfrgdrfx: $s_username</h3>";
    }if ($time >= "12" && $time < "17") {
     "<h3 style='font-size:18px;'><img src='images/ramadan/maxresdefault-5.jpg' width='150'>Good afternoon : $s_username</h3>";
    }if ($time >= "17" && $time < "19") {
  ...
  <div class="col-md-4" >
   ...
   <!--  <div class="col-md-4">
          <div class="card" style="padding-bottom: auto;">
              ...
              <div class="card-body">
                  <center>
                      <img class="card-img" src='images/دعاء-عرفه-1.jpg' style='background-size: contain;background-repeat: no-repeat;'>
         ...
         <div class="col-md-4">
            <div class="card zoom apixu-weather-cover">
              <div class="card-header">
                ...
                <div  class="card-body" 
                style="padding:5px 5px 10px 5px;background-size: cover;">
                <iframe class="vh-100" width="100%"  src="https://www.addictinggames.com/embed/html5-games/24682">                 
              </iframe>
            </div>
          </div>
        </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              ...
              <h5 class="modal-title" id="mediumModalLabel" style="text-align:center; color:#fff; font-size:25px;
                  font-weight:bold; float:right;" dir="ltr">
                     <!--i ><img rel="icon" 
                     src="images/Al-Mawled-Al-Nabawy-Ar.png" style="width:10%;filter: brightness(0.9);"/> 
                   </i-->

                     كـــــل عـــــام وأنــتــــم بــخــيــــر                      
                     <!--i ><img rel="icon" src="images/Iconarchive-Cute.png" style="width:10%;filter: brightness(0.9);"/> 
                   </i-->
                             </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              ...
              <div class="modal-body">
    <center>
      <img width="90%" height="330" src="images/عيد_العمال.jpg" style="background-repeat:no-repeat;">
    <br>
    <br>
     <div style="text-align: left;">
    Dears,<br>
     Kindly  create official mission with note Eid vacation from 5 till 9-June-2025   if you take it as holiday and don’t forget to mention the start and end time of the shift in order to approve the leaves and to avoid any deduction.
    <br>
     </div>
           </div>
              <div class="modal-footer">
