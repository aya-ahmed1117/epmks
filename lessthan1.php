...
<table class="table table-hover"  cellspacing="0" width="150%" id="tblCustomers" >
  ...
  <tbody>';
   ...
   $mttr = sqlsrv_query($connect,"
    SELECT distinct *
    ,Iif(datediff(day,creation_time,[Final_close])=0,'less than 1 day',
    iif(datediff(day,creation_time,[Final_close]) between 1 and 2 ,'From 1 to 2 days',
