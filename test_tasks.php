...
<div  class="input-group"id="inputGroupSelect01div">
  ...
  <!--select id="inputGroupSelect01" class="form-control sType" name="type"    required-->
    <select class="form-control sType"  id="inputGroupSelect01" required="true">
...
$check_orders = sqlsrv_query( $con ,"SELECT top 5 * FROM create_task WHERE engineer_id= '$self' order by [creation_time] DESC");
