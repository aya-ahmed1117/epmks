  ...
  echo'<li ><a id="myDIV" href="Admin_approve.php" >
      ...
      <i class="bi bi-chevron-down"></i></a>
          <ul>    
            ...
            <li><a href="add_users_training.php">Add users
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <div class="u-background-video u-expanded">
        ...
        <div  class="middles">
          <h3 >
           يشرفنا أن نرفع لكم أسمى آيات التهاني والتبريكات بمناسبة حلول شهر رمضان المبارك أعاده الله علينا وعليكم وعلى الأمة الإسلامية بالخير واليمن والبركات، وأعاننا وإياكم على صيامه وقيامه إنه سميع مجيب، وكل عام وأنتم بخير.
...
<?php
    ...
    if ($time < "12:06" ) {
     echo"<div class='containers'>";
            ...
            <source src="images/ramadan/fnaneesss.mp4">
        </video>';
             echo"
                <div class='centereds'>
   ...
   if ($time >=  "23:59") {
           ...
           <img class='card-img-top'src='images/ramadan/fool.gif' style='background-size: cover;background-repeat: no-repeat;height:350px;'>
              <div class='centereds'>
                ...
                style='font-weight: bold; font-size:25px;'dir='rtl'>وقت السحور : 
                  $s_username</h4>
                </div>
              </div>";
              }
  ...
  <div class="content">
    ...
    <div class="col-md-4">
          <div class="card" style="padding-bottom: auto;">
              ...
              <div class="card-body">
                    <center>
                      <img class="card-img" src='images/ramadan/ramadaK.webp' style='background-size: contain;background-repeat: no-repeat; width: 69%;'>
...
$repramadanN = str_replace('”' , "`", $ramadanN);
  ...
  <span class="snowflake"><img src="images/confetti.png" width="15"></span>
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content"style="background-image: url(images/eaid_fetr.jpg); background-repeat:no-repeat;
          background-size:cover;  ">
              <div class="modal-header" style="background-color: rgba(0, 0, 0, 0.6);">
                  ...
                  font-weight:bold; " >
                   <i ><img rel="icon" src="images/blaleen.gif" style="width:10%;filter: brightness(0.9);"/> 
                   </i>
عـــــيد سعيـــــــد
                   <img rel="icon" src="images/blaleen.gif" style="width:10%;filter: brightness(0.9);"/> 
                    </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<br>
  ...
  <h2 height:"250">
  Kindly  create official mission with note Eid El-Fitr from 29-Mar till 1-Apr-2025 if you take it as holiday and don’t forget to mention the start and end time of the shift in order to approve the leaves and to avoid any deduction.</h2>
<br>
<br>
<!--audio controls >
